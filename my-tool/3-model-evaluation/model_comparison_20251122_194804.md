...
**生成时间**: 2025-11-22 19:49:02

## 模型信息

- **原始模型**: 原始模型 (C:\niiya\tools\AI\FunASR\models\SenseVoiceSmall)
- **微调模型**: 微调模型 (model.pt.ep73)
- **测试样本数**: 468
...
| 模型 | 测试样本 | 正确识别 | 准确率 |
|------|---------|---------|--------|
| 原始模型 (C:\niiya\tools\AI\FunASR\models\SenseVoiceSmall) | 468 | 223 | 47.65% |
| 微调模型 (model.pt.ep73) | 468 | 381 | 81.41% |
...
**真实文本**: 路口右转 在右转时直奔前面的车辆开去 压力性1分 舒适性4分 效率性4分 预测性1分
...
- **差异**: `路口右转在右转时直奔前面的车辆开去压力性一分舒适性四分效率性四分热性一分` vs `路口右转在右转时直奔前面的车辆开去压力性1分舒适性4分效率性4分预测性1分`
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>路口左转 左转到目标车道后 有减速 减速不是很舒适`
- **识别文本**: 路口左转 左转到目标车道后 有减速 减速不是很舒适
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>环岛 这个环岛表现很差 在车道中间选择错误的车道 舒适性2分 预测性2分 剪辑`
- **识别文本**: 环岛 这个环岛表现很差 在车道中间选择错误的车道 舒适性2分 预测性2分 剪辑
...
- **状态**: ❌ 错误
- **原始输出**: `<|en|><|NEUTRAL|><|Speech|><|woitn|>v rU handleling`
- **识别文本**: v rU handleling
- **差异**: `vruhandleling` vs `vruhandling`
...
**真实文本**: 路口直行在夜间没有红绿灯的路口通过不减速 压力性3分 效率性3分 预测性3分
...
- **差异**: `路口直行在夜间没有红绿灯的路口通过不减速压力性三分效率性三分预测性三分` vs `路口直行在夜间没有红绿灯的路口通过不减速压力性3分效率性3分预测性3分`

#### 微调模型 (model.pt.ep73)

- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>路口直行在夜间没有红绿灯的路口通过不减速 压力性3分 效率性3分 预测性3分`
- **识别文本**: 路口直行在夜间没有红绿灯的路口通过不减速 压力性3分 效率性3分 预测性3分
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>路口直行 在旁边车辆车辆切入的时候 不选择避让旁边车辆有点抢路 压力性3分 舒适性3分 效率性5分`
- **识别文本**: 路口直行 在旁边车辆车辆切入的时候 不选择避让旁边车辆有点抢路 压力性3分 舒适性3分 效率性5分
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>跟车 KD 受到旁边车辆影响 误减速 NSS 舒适性3分`
- **识别文本**: 跟车 KD 受到旁边车辆影响 误减速 NSS 舒适性3分
...
**真实文本**: 车道保持 一直压黄色车道线 压力性3分 预测性3分
...
- **差异**: `车道保持一直压黄色车道线压力性三分预测性三分` vs `车道保持一直压黄色车道线压力性3分预测性3分`
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>左前方车辆切入本车一直压左侧车道线行驶 且未减速有碰撞风险 压力性2分 预测性2分 剪辑`
- **识别文本**: 左前方车辆切入本车一直压左侧车道线行驶 且未减速有碰撞风险 压力性2分 预测性2分 剪辑
...
- **状态**: ❌ 错误
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>路口直行 过路口时 受到对向向左转弯车影响 停在路口中间 效率性2分 压力性2分 预测性2分 剪辑`
- **识别文本**: 路口直行 过路口时 受到对向向左转弯车影响 停在路口中间 效率性2分 压力性2分 预测性2分 剪辑
...
**真实文本**: 弱势群体 在路口直行过程中 受弱势群体的不必要减速至停止 效率性2分 预测性2分
...
- **差异**: `弱势群体在路口执行过程中受弱势群体的不必要减速至停止效率性二分预测性二分` vs `弱势群体在路口直行过程中受弱势群体的不必要减速至停止效率性2分预测性2分`

#### 微调模型 (model.pt.ep73)

- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>弱势群体 在路口直行过程中 受弱势群体的不必要减速至停止 效率性2分 预测性2分`
- **识别文本**: 弱势群体 在路口直行过程中 受弱势群体的不必要减速至停止 效率性2分 预测性2分
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>其他 在园区内可以开启智驾`
- **识别文本**: 其他 在园区内可以开启智驾
...
- **状态**: ❌ 错误
- **原始输出**: `<|en|><|NEUTRAL|><|Speech|><|woitn|>dunkction turn`
- **识别文本**: dunkction turn
- **差异**: `dunkctionturn` vs `junctionturn`
...
- **状态**: ❌ 错误
- **原始输出**: `<|en|><|NEUTRAL|><|Speech|><|woitn|>V areU handleling`
- **识别文本**: V areU handleling
- **差异**: `vareuhandleling` vs `vruhandling`
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>弱势群体 躲避对向车道来的弱势群体 向右打了把方向`
- **识别文本**: 弱势群体 躲避对向车道来的弱势群体 向右打了把方向
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>环岛结束后 走两条路中间压虚线 然后再向左边动 预测性3分`
- **识别文本**: 环岛结束后 走两条路中间压虚线 然后再向左边动 预测性3分
...
- **状态**: ❌ 错误
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>道路切换4828`
- **识别文本**: 道路切换4828
- **差异**: `道路切换4828` vs `道路切换`
...
**真实文本**: 弱势群体避让 它选择去避让一个还有很久才能过来的自行车 效率性3分 压力性5分
...
- **差异**: `弱势群体避让他选择去避让一个还有很久才能过来的自行车效率性三分压力性五分` vs `弱势群体避让它选择去避让一个还有很久才能过来的自行车效率性3分压力性5分`
...
- **差异**: `弱势群体避让他选择去避让一个还有很久才能过来的自行车效率性3分压力性5分` vs `弱势群体避让它选择去避让一个还有很久才能过来的自行车效率性3分压力性5分`
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>弱势群体 识别路边 临停停止的电动三轮车有绕行`
- **识别文本**: 弱势群体 识别路边 临停停止的电动三轮车有绕行
...
- **差异**: `环导环岛后路线规划有点问题预测性三分` vs `环岛环岛后路线规划有点问题预测性3分`
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>障碍物绕行 识别旁边停止的车辆有绕行`
- **识别文本**: 障碍物绕行 识别旁边停止的车辆有绕行
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>路口右转 受到左侧车辆影响 在出口有个减速 但是那辆车还很远 预测性3分`
- **识别文本**: 路口右转 受到左侧车辆影响 在出口有个减速 但是那辆车还很远 预测性3分
...
- **状态**: ❌ 错误
- **原始输出**: `<|en|><|NEUTRAL|><|Speech|><|woitn|>gren light`
- **识别文本**: gren light
- **差异**: `grenlight` vs `greenlight`
...
**真实文本**: 路口直行 路口直行后选择变道 离旁边车辆太近了 预测性1分 压力性1分 舒适性 4分
...
- **差异**: `路口直行路口直行后选择变道离旁边车辆太近了预测性一分压力性一分舒适性四分` vs `路口直行路口直行后选择变道离旁边车辆太近了预测性1分压力性1分舒适性4分`
...
- **状态**: ❌ 错误
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>路口直行 当对象来车想要左转时 没有提前减速 停车 而是选择开到了离对象车很近的位置 跟他对上 预测性2分 压力性2分`
- **识别文本**: 路口直行 当对象来车想要左转时 没有提前减速 停车 而是选择开到了离对象车很近的位置 跟他对上 预测性2分 压力性2分
- **差异**: `路口直行当对象来车想要左转时没有提前减速停车而是选择开到了离对象车很近的位置跟他对上预测性2分压力性2分` vs `路口直行当对象来车想要左转时没有提前减速停车而是选择开到了离对象车很近的位置跟他对上预测性两分压力性2分`
...
- **状态**: ❌ 错误
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>车道保持 大堤路向右转弯时候压实线 预测性3分`
- **识别文本**: 车道保持 大堤路向右转弯时候压实线 预测性3分
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>弱势群体 变道时躲避左侧电瓶车辆减速`
- **识别文本**: 弱势群体 变道时躲避左侧电瓶车辆减速
...
- **状态**: ❌ 错误
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>党没岛`
- **识别文本**: 党没岛
- **差异**: `党没岛` vs `导航变道`
...
- **状态**: ❌ 错误
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>弱势群体 识别路边 蹲下洗车的人 并且有减速`
- **识别文本**: 弱势群体 识别路边 蹲下洗车的人 并且有减速
- **差异**: `弱势群体识别路边蹲下洗车的人并且有减速` vs `弱势群体识别路旁边蹲下洗车的人并且有减速`
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>其他 退出智驾 剪辑`
- **识别文本**: 其他 退出智驾 剪辑
...
- **状态**: ❌ 错误
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>口直行`
- **识别文本**: 口直行
- **差异**: `口直行` vs `路口直行`
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>限速信息 前方限速60 识别为50 自车车速60`
- **识别文本**: 限速信息 前方限速60 识别为50 自车车速60
...
- **状态**: ❌ 错误
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>大面岛`
- **识别文本**: 大面岛
- **差异**: `大面岛` vs `导航变道`
...
**真实文本**: 车道保存 一直压左侧车道线 压力性3分 预测性3分
...
- **差异**: `车道保存一直压左侧车道线压力型塞分预测型` vs `车道保存一直压左侧车道线压力性3分预测性3分`
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>限速信息 识别到限速牌 限速50 自车识别50 本车车速60`
- **识别文本**: 限速信息 识别到限速牌 限速50 自车识别50 本车车速60
...
**真实文本**: 导航变道 但变道过程有犹豫嗯别到了左后方车辆压力性3分
...
- **差异**: `导航变道但变道过程有犹豫变道了左后方车辆压力性三分` vs `导航变道但变道过程有犹豫嗯别到了左后方车辆压力性3分`
...
- **差异**: `导航变道但变道过程有犹豫别到了左后方车辆压力性3分` vs `导航变道但变道过程有犹豫嗯别到了左后方车辆压力性3分`
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>路口左转 左转待转区识别有问题 红灯时本车已超过停止线进入待转区 效率性3分压力性3分`
- **识别文本**: 路口左转 左转待转区识别有问题 红灯时本车已超过停止线进入待转区 效率性3分压力性3分
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>复杂场景 宽度比较窄 是可以允许车辆宽度通行 本车速度降为0 不继续行驶 效率性1分 驾驶员接管 剪辑`
- **识别文本**: 复杂场景 宽度比较窄 是可以允许车辆宽度通行 本车速度降为0 不继续行驶 效率性1分 驾驶员接管 剪辑
...
- **差异**: `红灯跟车红灯跟车起步太慢效率性三分` vs `红灯跟车红灯跟车起步太慢效率性3分`
...
**真实文本**: 车道保持 偏左行驶压左侧车道线 预测性3分 压力性3分
...
- **差异**: `车道保持偏左行驶压左侧车道线预测性三分压力性三分` vs `车道保持偏左行驶压左侧车道线预测性3分压力性3分`
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>车道保持 路上右转压实线 预测性3分`
- **识别文本**: 车道保持 路上右转压实线 预测性3分
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>其他 刚出潮汐车道的范围内 华为ADS4 0自动激活`
- **识别文本**: 其他 刚出潮汐车道的范围内 华为ADS4 0自动激活
...
- **状态**: ❌ 错误
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>汇入变道 汇入到辅助中行驶`
- **识别文本**: 汇入变道 汇入到辅助中行驶
- **差异**: `汇入变道汇入到辅助中行驶` vs `汇入变道汇入到辅路中行驶`
...
- **状态**: ❌ 错误
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>障碍物绕行 前方有静止车辆本车也不会绕行 效率性2分驾驶员接管`
- **识别文本**: 障碍物绕行 前方有静止车辆本车也不会绕行 效率性2分驾驶员接管
...
- **状态**: ❌ 错误
- **原始输出**: `<|en|><|NEUTRAL|><|Speech|><|woitn|>juongction street`
- **识别文本**: juongction street
- **差异**: `juongctionstreet` vs `junctionstraight`
...
**真实文本**: 路口直行 路口直行的过程中有一个向左的超车变道 预测性4分 效率性5分
...
- **差异**: `路口执行路口执行的过程中有一个向左的超时变道预测性四分效率性五分` vs `路口直行路口直行的过程中有一个向左的超车变道预测性4分效率性5分`
...
- **状态**: ❌ 错误
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>路口直行 直行后受后方车辆影响晃了一下`
- **识别文本**: 路口直行 直行后受后方车辆影响晃了一下
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>车道保持 进环岛之前 车往右晃了一下 又回去了 应该是想要变道 但是发现变道又不合适 就取消了 预测性3分`
- **识别文本**: 车道保持 进环岛之前 车往右晃了一下 又回去了 应该是想要变道 但是发现变道又不合适 就取消了 预测性3分
...
- **差异**: `红灯领航红绿灯识别失败预测性一分压力性一分` vs `红灯领航红绿灯识别失败预测性1分压力性1分`
...
- **状态**: ❌ 错误
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>vRU 航道ling`
- **识别文本**: vRU 航道ling
- **差异**: `vru航道ling` vs `vruhandling`
...
- **状态**: ❌ 错误
- **原始输出**: `<|en|><|NEUTRAL|><|Speech|><|woitn|>bRU handle`
- **识别文本**: bRU handle
- **差异**: `bruhandle` vs `vruhandling`
...
**真实文本**: 环岛 进环岛前速度很快 减到30公里每小时 在环岛中尝试多次尝试变道 且方向盘有点左右乱晃 速度稍微有点快 出环岛时 方向盘也乱晃 预测性3分 压力性3分
...
- **差异**: `ok环岛进环岛前速度很快减到三十公里每小时在环岛中尝试多次尝试变道且方向盘有点左右乱晃速度稍微有点快出环岛时方向盘也乱晃预测性三分压力性三分` vs `环岛进环岛前速度很快减到30公里每小时在环岛中尝试多次尝试变道且方向盘有点左右乱晃速度稍微有点快出环岛时方向盘也乱晃预测性3分压力性3分`

#### 微调模型 (model.pt.ep73)

- **状态**: ✅ 正确
- **原始输出**: `<|en|><|EMO_UNKNOWN|><|Speech|><|woitn|> <|zh|><|NEUTRAL|><|Speech|><|woitn|>环岛 进环岛前速度很快 减到30公里每小时 在环岛中尝试多次尝试变道 且方向盘有点左右乱晃 速度稍微有点快 出环岛时 <|zh|><|NEUTRAL|><|Speech|><|woitn|>方向盘也乱晃 预测性3分 压力性3分`
- **识别文本**: 环岛 进环岛前速度很快 减到30公里每小时 在环岛中尝试多次尝试变道 且方向盘有点左右乱晃 速度稍微有点快 出环岛时 方向盘也乱晃 预测性3分 压力性3分
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>车道保持 在接近路口时有一个很大的横摆 压力性3分`
- **识别文本**: 车道保持 在接近路口时有一个很大的横摆 压力性3分
...
**真实文本**: 跟车 莫名其妙减速 NSS 预测性3分 舒适性3分
...
- **差异**: `跟车莫名其妙减速nss预测性三分数适性三分` vs `跟车莫名其妙减速nss预测性3分舒适性3分`

#### 微调模型 (model.pt.ep73)

- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>跟车 莫名其妙减速 NSS 预测性3分 舒适性3分`
- **识别文本**: 跟车 莫名其妙减速 NSS 预测性3分 舒适性3分
...
**真实文本**: 路口执行 过入口时有无意义的换道压力性3分 舒适性3分剪辑
...
- **差异**: `路口直行过路口时有不明意的管道压力性三分舒适性三分紧急` vs `路口执行过入口时有无意义的换道压力性3分舒适性3分剪辑`

#### 微调模型 (model.pt.ep73)

- **状态**: ❌ 错误
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>路口直行 过入口时有不明义的换道压力性3分 舒适性3分 剪辑`
- **识别文本**: 路口直行 过入口时有不明义的换道压力性3分 舒适性3分 剪辑
- **差异**: `路口直行过入口时有不明义的换道压力性3分舒适性3分剪辑` vs `路口执行过入口时有无意义的换道压力性3分舒适性3分剪辑`
...
- **状态**: ❌ 错误
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>跟车 车辆突然异常减速 预测性两分 压力性2分`
- **识别文本**: 跟车 车辆突然异常减速 预测性两分 压力性2分
- **差异**: `跟车车辆突然异常减速预测性两分压力性2分` vs `跟车车辆突然异常减速预测性两分压力性两分`
...
- **差异**: `路口直行通过路口后压左线预测性三分` vs `路口直行通过路口后压左线预测性3分`
...
- **状态**: ❌ 错误
- **原始输出**: `<|en|><|NEUTRAL|><|Speech|><|woitn|>zngcent`
- **识别文本**: zngcent
- **差异**: `zngcent` vs `junctionstraight`
...
- **状态**: ❌ 错误
- **原始输出**: `<|en|><|NEUTRAL|><|Speech|><|woitn|>Ledeng`
- **识别文本**: Ledeng
- **差异**: `ledeng` vs `绿灯`
...
- **状态**: ❌ 错误
- **原始输出**: `<|en|><|NEUTRAL|><|Speech|><|woitn|>chgelan`
- **识别文本**: chgelan
- **差异**: `chgelan` vs `changelane`
...
**真实文本**: VRU Handling VRU侵入我们的 driving tube 时 刹车不够及时 有碰撞风险 预测性1分 压力性1分
...
- **差异**: `vruhandlingvru侵入到我们的driving兵tube时刹车不够及时有碰撞风险预测性一分压力性一分` vs `vruhandlingvru侵入我们的drivingtube时刹车不够及时有碰撞风险预测性1分压力性1分`

#### 微调模型 (model.pt.ep73)

- **状态**: ❌ 错误
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>VRU Handling VRU侵入到我们的 driving tube 时 刹车不够及时 有碰撞风险 预测性1分 压力性1分`
- **识别文本**: VRU Handling VRU侵入到我们的 driving tube 时 刹车不够及时 有碰撞风险 预测性1分 压力性1分
- **差异**: `vruhandlingvru侵入到我们的drivingtube时刹车不够及时有碰撞风险预测性1分压力性1分` vs `vruhandlingvru侵入我们的drivingtube时刹车不够及时有碰撞风险预测性1分压力性1分`
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>环岛 出环岛后 又找左侧左侧第二条车道 道路开的绝对不合理呀 <|zh|><|NEUTRAL|><|Speech|><|woitn|>预测性2分`
- **识别文本**: 环岛 出环岛后 又找左侧左侧第二条车道 道路开的绝对不合理呀 预测性2分
...
- **状态**: ✅ 正确
- **原始输出**: `<|en|><|NEUTRAL|><|Speech|><|woitn|>绿灯`
- **识别文本**: 绿灯
...
- **状态**: ❌ 错误
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>导航变道 变道后压实线就往回甩 呃 拐大了 也变道特别 特别 让人感到 <|zh|><|NEUTRAL|><|Speech|><|woitn|>突然 舒适性3分`
- **识别文本**: 导航变道 变道后压实线就往回甩 呃 拐大了 也变道特别 特别 让人感到 突然 舒适性3分
...
**真实文本**: 红灯领航 在黄灯马上要变成红灯的时候 还在 还没有减速 然后当意识到马上要过不去 变成红灯的时候 急速刹停并且智驾退出 预测性1分 压力性1分 舒适性一般 效率性1分
...
- **差异**: `红灯领航在黄灯马上要变成红灯的时候还在还没有减速然后当意识到了马上要过不去变成红灯的时候急速杀停并且支驾退出预测性一分压力性一分舒适性一分效率性一分` vs `红灯领航在黄灯马上要变成红灯的时候还在还没有减速然后当意识到马上要过不去变成红灯的时候急速刹停并且智驾退出预测性1分压力性1分舒适性一般效率性1分`

#### 微调模型 (model.pt.ep73)

- **状态**: ❌ 错误
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>红灯领航 在黄灯马上要变成红灯的时候 还在 还没有减速 然后当意识到了马上要过不去 <|zh|><|NEUTRAL|><|Speech|><|woitn|>变成红灯的时候 急速刹停并且智驾退出 预测性1分 压力性1分 舒适性1分 效率性1分`
- **识别文本**: 红灯领航 在黄灯马上要变成红灯的时候 还在 还没有减速 然后当意识到了马上要过不去 变成红灯的时候 急速刹停并且智驾退出 预测性1分 压力性1分 舒适性1分 效率性1分
- **差异**: `红灯领航在黄灯马上要变成红灯的时候还在还没有减速然后当意识到了马上要过不去变成红灯的时候急速刹停并且智驾退出预测性1分压力性1分舒适性1分效率性1分` vs `红灯领航在黄灯马上要变成红灯的时候还在还没有减速然后当意识到马上要过不去变成红灯的时候急速刹停并且智驾退出预测性1分压力性1分舒适性一般效率性1分`
...
**真实文本**: 环岛 在环岛里的路线总是 导致了压力有点大 压力性3分 预测性3分
...
- **差异**: `环岛在环岛里的路线总是导致的压力有点大压力性三分预测性三分` vs `环岛在环岛里的路线总是导致了压力有点大压力性3分预测性3分`

#### 微调模型 (model.pt.ep73)

- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>环岛 在环岛里的路线总是 导致了压力有点大 压力性3分 预测性3分`
- **识别文本**: 环岛 在环岛里的路线总是 导致了压力有点大 压力性3分 预测性3分
...
- **差异**: `前车切入右侧有车辆接入本车速度过慢效率响三分` vs `前车切入右侧有车辆切入本车速度过慢效率性3分`
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>路口左转 速度较慢 路口较窄 有对向有车 效率性3分`
- **识别文本**: 路口左转 速度较慢 路口较窄 有对向有车 效率性3分
...
**真实文本**: 弱势群体避让 弱势群体侵入我们车道后 刹车不够及时 有碰撞风险 预测性1分 压力性1分
...
- **差异**: `弱势群体避让弱势群体侵入到我们车道后刹车不够及时有碰撞风险预测性一分压力性一分` vs `弱势群体避让弱势群体侵入我们车道后刹车不够及时有碰撞风险预测性1分压力性1分`
...
- **差异**: `弱势群体避让弱势群体侵入到我们车道后刹车不够及时有碰撞风险预测性1分压力性1分` vs `弱势群体避让弱势群体侵入我们车道后刹车不够及时有碰撞风险预测性1分压力性1分`
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>环岛 <|zh|><|NEUTRAL|><|Speech|><|woitn|>进环岛时 打转向灯 在环岛内行驶压线行驶 变道时不打转向灯 在变道快要结束时打转向灯 预测性3分 压力性3分 剪辑`
- **识别文本**: 环岛 进环岛时 打转向灯 在环岛内行驶压线行驶 变道时不打转向灯 在变道快要结束时打转向灯 预测性3分 压力性3分 剪辑
...
- **状态**: ❌ 错误
- **原始输出**: `<|en|><|NEUTRAL|><|Speech|><|woitn|>s呀`
- **识别文本**: s呀
- **差异**: `s呀` vs `cl`
...
**真实文本**: 路口直行 在过路口时 后侧有车已经贴近 并排行走行走时 本车往左侧车身上贴 预测性1分 压力性1分
...
- **差异**: `路口直行在过路口时后侧有车已经贴近并排行走行走时本车往左侧车身上贴预测性一分压力性一分` vs `路口直行在过路口时后侧有车已经贴近并排行走行走时本车往左侧车身上贴预测性1分压力性1分`

#### 微调模型 (model.pt.ep73)

- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>路口直行 在过路口时 后侧有车已经贴近 并排行走 行走时 本车往左侧车身上贴 预测性1分 压力性1分`
- **识别文本**: 路口直行 在过路口时 后侧有车已经贴近 并排行走 行走时 本车往左侧车身上贴 预测性1分 压力性1分
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>绿灯 绿灯变黄灯时 闯黄灯 效率性5分`
- **识别文本**: 绿灯 绿灯变黄灯时 闯黄灯 效率性5分
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>路线规划 没有按正确的车道线行驶 没有提前变到右侧右转专用道 剪辑`
- **识别文本**: 路线规划 没有按正确的车道线行驶 没有提前变到右侧右转专用道 剪辑
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>施工路段 被锥桶挡住 完全动不了 效率性2分`
- **识别文本**: 施工路段 被锥桶挡住 完全动不了 效率性2分
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>红灯领航 红灯响应慢 预测性3分 效率性3分`
- **识别文本**: 红灯领航 红灯响应慢 预测性3分 效率性3分
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>弱势群体 能够避让骑自行车的老头儿 预测性5分`
- **识别文本**: 弱势群体 能够避让骑自行车的老头儿 预测性5分
...
- **状态**: ❌ 错误
- **原始输出**: `<|en|><|NEUTRAL|><|Speech|><|woitn|>zhangctioneng turn`
- **识别文本**: zhangctioneng turn
- **差异**: `zhangctionengturn` vs `junctionturn`
...
- **状态**: ✅ 正确
- **原始输出**: `<|zh|><|NEUTRAL|><|Speech|><|woitn|>前车切入 刹车不舒适 压力3分 舒适性3分`
- **识别文本**: 前车切入 刹车不舒适 压力3分 舒适性3分
...
- **状态**: ❌ 错误
- **原始输出**: `<|en|><|NEUTRAL|><|Speech|><|woitn|>Red light leadingad`
- **识别文本**: Red light leadingad
- **差异**: `redlightleadingad` vs `redlightleading`
